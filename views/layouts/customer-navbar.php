    ...
    <div class="flex h-16 justify-between">
        ...
        <div class="hidden sm:block">
            ...
            <a
                ...
                class="text-white <?= uriIs('/customer/deposit') ?> rounded-md py-2 px-3 text-sm font-medium"
                >Deposit</a
            >
            <a
                href='/customer/withdraw'
                class="text-white <?= uriIs('/customer/withdraw') ?> rounded-md py-2 px-3 text-sm font-medium"
                >Withdraw</a
            >
            <a
                href='/customer/transfer'
                class="text-white <?= uriIs('/customer/transfer') ?> rounded-md py-2 px-3 text-sm font-medium"
                >Transfer</a
            >
            </div>
        </div>
